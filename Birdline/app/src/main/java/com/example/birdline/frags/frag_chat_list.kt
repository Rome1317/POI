...
class frag_chat_list : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rv_superhero = root.findViewById<RecyclerView>(R.id.listChatsRecyclerView)

        rv_superhero.layoutManager   = LinearLayoutManager(root.context)
        val adapter = ChatAdapter(root.context, chats)
